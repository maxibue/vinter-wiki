...
<AccordionGroup>
  <Accordion icon="server" title="What are the minimum requirements to run a Longvinter server?">
    ...
    - Min. 3 GB RAM
    - Min. 64-bit Operating System (Windows 10 or Linux)
...
<AccordionGroup>
  <Accordion icon="triangle-exclamation" title="My server isn't showing up in the server list. What should I do?">
    ...
    2. Check that you've properly configured port forwarding for ports 7777 (UDP) and 27016 (TCP and UDP)
    3. Verify that your firewall isn't blocking these ports
    4. Restart your server and router
    
    If problems persist, check your server logs for any error messages.
  </Accordion>

  <Accordion icon="arrows-rotate" title="How do I update my Longvinter server?">
    To update your Longvinter server:
